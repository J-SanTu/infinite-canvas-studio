...
These attribution notes apply to the animation assets bundled with the local desktop edition. Runtime playback is offline and does not require an account, remote asset service, or provider credential.
