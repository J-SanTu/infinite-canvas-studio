...
普通用户从 GitHub Releases 下载对应平台 ZIP 并解压：

- Windows：运行 `Santu Infinite Canvas-0.2.0-x64-setup.exe`；也可以直接运行便携版 EXE，无需安装。
- Apple 芯片 macOS：打开 DMG，将应用拖到“应用程序”。应用当前未签名，首次启动请按住 Control 点击，选择“打开”并确认。
