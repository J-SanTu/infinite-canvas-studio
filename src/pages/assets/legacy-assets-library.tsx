...
function assetSummary(asset: Asset) {
    ...
    return asset.kind === "audio" ? `${formatBytes(asset.data.bytes)} · ${asset.data.mimeType}` : `${asset.data.width}x${asset.data.height} · ${formatBytes(asset.data.bytes)} · ${asset.data.mimeType}`;
}
