...
export function AppTopNav() {
    ...
    const moreActive = pathname === "/config";
    const moreItems = [{ key: "config", label: "本地设置", icon: <Settings2 className="size-4" /> }];
                    ...
                    <div className="mx-auto flex h-full max-w-7xl items-stretch justify-between gap-5 px-6">
                        <div className="flex min-w-0 items-center">
                            <Link to="/" className="flex h-full shrink-0 items-center gap-2 text-sm font-semibold leading-none tracking-tight text-stone-950 transition hover:text-stone-600 dark:text-stone-100 dark:hover:text-stone-300">
                                <span
                                    className="h-5 w-10 shrink-0 bg-current"
                                    style={{
                            ...
                            <UserStatusActions
                                ...
                                utilityAction={
                                    <Dropdown
                                        ...
                                        menu={{
                                            items: moreItems,
                                            selectedKeys: moreActive ? ["config"] : [],
                                    ...
                                    >
                                        <button
                                            ...
                                            title="更多导航"
                                            className={cn(
                                                "hidden size-7 shrink-0 items-center justify-center transition md:inline-flex",
                                                moreActive ? "text-stone-950 dark:text-stone-100" : "text-stone-600 hover:text-stone-950 dark:text-stone-300 dark:hover:text-white",
                                            )}
                                        >
