...
export function UserStatusActions({ showConfig = true, variant = "default", onOpenShortcuts, utilityAction }: UserStatusActionsProps) {
    ...
    return (
        <div className="inline-flex shrink-0 items-center gap-1">
            {showConfig ? (
                <button type="button" className={iconClass} style={iconStyle} onClick={() => openConfigDialog(false)} aria-label="本地设置" title="本地设置">
